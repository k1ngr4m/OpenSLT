...
进入运行详情的“运行对比”页签。当前运行产生统计指标后，系统会列出同场景已完成运行，并优先推荐工作流版本、统计脚本、异常大值上限和指标单位一致且人工结论为“通过”的运行。
...
保存或更新对比快照后，应在“产物与报告”页签重新生成报告。新版本 HTML、Excel 和 PDF 会包含该快照，已有历史报告保持不变。
