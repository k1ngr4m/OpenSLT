# OpenSLT 自动化测速平台主流程使用说明书

| 文档属性 | 内容 |
| --- | --- |
| 适用系统 | OpenSLT 自动化测速平台 |
| 系统版本 | 0.2.0 |
| 文档版本 | 1.0 |
| 编制日期 | 2026-07-30 |
| 适用读者 | 系统管理员、测试人员 |
...
- 只可选择当前节点之前最近一次成功解析生成的 CSV。
- 勾选统计文件并保存输入选择，再开始统计。
- 统计成功后检查样本数、单位和数据来源是否符合预期。
...
1. 页签区包含应用与运行、HTTP、SQL、WebSocket 和审计日志。
...
3. 涉及接口失败时查看 HTTP 页签。
4. 涉及平台库或业务库时查看 SQL 页签。
5. 终端实时输出异常时查看 WebSocket 页签。
6. 需要确认操作人和变更动作时查看审计日志。
