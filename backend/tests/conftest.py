...
def create_resource(client: TestClient, headers: dict[str, str], name: str, resource_type: str = "rem") -> dict:
...
def create_plan_scenario(client: TestClient, headers: dict[str, str], required_types: list[str] | None = None) -> tuple[dict, dict]:
