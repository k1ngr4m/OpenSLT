...
class SSHAdapter:
    async def check(self, *, host: str, port: int, username: str, password: str | None = None, private_key: str | None = None) -> dict[str, str | bool]:
    ...
    async def stream(self, connection: asyncssh.SSHClientConnection, command: str) -> AsyncIterator[tuple[str, str]]:
