...
.capture-key,.capture-description{margin:4px 0 0;font-size:12px;line-height:1.45;word-break:break-word}.capture-value{line-height:1.55;white-space:pre-wrap;word-break:break-word}
