...
<style scoped>
.wiring-topology{width:100%;min-width:0;max-width:100%;overflow:hidden;border:1px solid var(--ui-border);border-radius:8px;background:var(--ui-surface-subtle)}.wiring-scroll{width:100%;min-width:0;overflow-x:auto;overscroll-behavior-inline:contain}.wiring-scroll:focus-visible{outline:2px solid var(--ui-primary);outline-offset:2px}.wiring-scroll svg{display:block;width:100%;min-width:760px;height:auto}.wiring-empty{display:flex;min-height:240px;flex-direction:column;align-items:center;justify-content:center;padding:28px;color:var(--ui-text-tertiary);text-align:center}.wiring-empty :deep(svg){width:34px;height:34px}.wiring-empty strong{margin-top:12px;color:var(--ui-text-secondary);font-size:14px}.wiring-empty span{max-width:34ch;margin-top:6px;font-size:12px;line-height:1.6}.device-shell,.switch-shell{fill:var(--ui-surface);stroke:#9badb1;stroke-width:1.5}.switch-shell{fill:var(--ui-surface-subtle)}.device-copy,.switch-copy{display:flex;width:100%;height:100%;flex-direction:column;align-items:center;justify-content:center;color:#20383e;text-align:center}.device-copy small{color:#718489;font-size:12px}.device-copy strong{margin-top:4px;color:var(--ui-primary);font-size:17px}.device-copy span{display:-webkit-box;max-width:100%;margin-top:7px;overflow:hidden;color:#52676c;font-size:12px;line-height:1.35;overflow-wrap:anywhere;-webkit-box-orient:vertical;-webkit-line-clamp:2}.switch-copy strong{display:-webkit-box;overflow:hidden;font-size:15px;line-height:1.4;-webkit-box-orient:vertical;-webkit-line-clamp:2}.switch-copy span{margin-top:7px;color:#718489;font-size:12px}.interface rect,.slnic-ports rect{fill:#dcefeb;stroke:#6da99e;stroke-width:1}.interface text{fill:#17353a;font-size:12px;font-weight:600;text-anchor:middle}.interface text.ip{font-family:"Cascadia Code",Consolas,monospace;font-size:12px;font-weight:500}.interface-name,.interface-ip{display:flex;width:100%;height:100%;align-items:center;justify-content:center}.interface-name input,.interface-name span,.interface-ip input{box-sizing:border-box;width:100%;height:22px;color:#17353a;font-family:inherit;font-size:12px;line-height:20px;text-align:center}.interface-name input,.interface-name span{font-weight:600}.interface-name span{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.interface-name input,.interface-ip input{border:1px solid #4c9588;border-radius:3px;outline:0;background:var(--ui-surface);padding:0 4px}.interface-ip input{height:20px;font-family:"Cascadia Code",Consolas,monospace;font-size:12px;line-height:18px}.interface-name input:focus,.interface-ip input:focus{border-color:var(--ui-primary);box-shadow:0 0 0 1px var(--ui-primary)}.slnic-ports text{fill:#20383e;font-size:12px}.slnic-ports .port-label{fill:#62767b;font-size:9px}.links path,.legend line{fill:none;stroke-width:2}.uplink{stroke:#c43d47}.downlink{stroke:#326eaa}.legend text{fill:#52676c;font-size:12px}.uplink-dot{fill:#c43d47}.downlink-dot{fill:#326eaa}.compact .wiring-scroll svg{min-width:720px}@media(max-width:767px){.wiring-scroll svg{min-width:720px}.wiring-empty{min-height:200px}}
</style>
