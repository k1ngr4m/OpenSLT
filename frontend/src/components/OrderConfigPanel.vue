...
<style scoped>
.config-workspace{display:grid;grid-template-columns:minmax(250px,290px) minmax(0,1fr);min-height:660px;overflow:hidden;border:1px solid var(--ui-border);border-radius:var(--ui-radius-panel);background:var(--ui-surface)}.config-sidebar{display:flex;flex-direction:column;gap:12px;padding:16px;border-right:1px solid var(--ui-border);background:var(--ui-surface-subtle)}.sidebar-heading{display:flex;align-items:center;justify-content:space-between}.sidebar-heading>div{display:flex;align-items:baseline;gap:8px}.sidebar-heading strong{font-size:14px}.sidebar-heading small{color:var(--ui-text-tertiary)}.file-list{display:flex;max-height:535px;flex-direction:column;gap:4px;overflow:auto}.file-item{display:grid;grid-template-columns:18px minmax(0,1fr);gap:8px;align-items:start;width:100%;padding:10px;border:1px solid transparent;border-radius:6px;background:transparent;color:var(--ui-text-primary);text-align:left;cursor:pointer;transition:background-color var(--ui-transition),border-color var(--ui-transition)}.file-item:hover{background:var(--ui-surface-subtle)}.file-item.active{border-color:#b9d8cf;background:var(--ui-primary-soft);color:var(--ui-primary-hover)}.file-item span{min-width:0}.file-item strong,.file-item small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.file-item strong{font:12px/1.5 "Cascadia Code",Consolas,monospace}.file-item small{margin-top:3px;color:var(--ui-text-tertiary);font-size:12px}.create-button{margin-top:auto}.file-empty,.editor-empty{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;color:var(--ui-text-tertiary)}.file-empty{min-height:180px;font-size:12px}.file-empty :deep(svg),.editor-empty :deep(svg){width:28px;height:28px}.config-editor{display:flex;min-width:0;flex-direction:column;padding:18px 20px}.config-alert,.xml-error{padding:9px 12px;border-radius:5px;font-size:12px}.config-alert{margin-bottom:10px;background:#fff3d9;color:#805d1e}.xml-error{margin-bottom:8px;background:#fdecee;color:var(--ui-danger)}.editor-empty{flex:1}.editor-empty strong{color:var(--ui-text-primary)}.editor-empty span{font-size:12px}.editor-toolbar,.editor-modebar,.editor-footer{display:flex;align-items:center;justify-content:space-between;gap:14px}.editor-toolbar{padding-bottom:13px;border-bottom:1px solid var(--ui-border)}.file-title{min-width:0}.file-title>div{display:flex;align-items:center;gap:8px}.file-title strong{display:block;overflow:hidden;font-size:13px;text-overflow:ellipsis;white-space:nowrap}.file-title small{display:block;margin-top:5px;color:var(--ui-text-secondary)}.editor-actions{display:flex;gap:8px}.editor-modebar{padding:12px 0}.mode-meta{display:flex;min-width:0;align-items:center;gap:9px;color:var(--ui-text-secondary);font-size:12px}.mode-meta .mono{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.editor-body{min-height:500px;max-height:585px;overflow:auto;border:1px solid var(--ui-border);border-radius:6px;background:#fbfcfd}.structured-editor{padding:14px}.raw-editor{height:100%}.raw-editor :deep(.el-textarea__inner){min-height:583px!important;border:0;border-radius:0;background:var(--ui-terminal);color:#dce6ee;font:12px/1.6 "Cascadia Code",Consolas,monospace;box-shadow:none}.editor-footer{padding-top:12px;color:var(--ui-text-secondary);font-size:12px}.editor-footer>div{display:flex;gap:8px}@media(max-width:900px){.config-workspace{grid-template-columns:220px minmax(440px,1fr);overflow:auto}.config-editor{padding:14px}}@media(max-width:767px){.config-workspace{grid-template-columns:1fr;min-height:0}.config-sidebar{max-height:280px;border-right:0;border-bottom:1px solid var(--ui-border)}.config-editor{min-width:520px}}
</style>
