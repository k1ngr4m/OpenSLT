...
.plan-head{display:flex;width:100%;min-height:58px;align-items:center;justify-content:space-between;gap:14px;padding-right:8px}.plan-title-main{display:flex;min-height:38px;align-items:center;min-width:0}.plan-toggle-icon{display:grid;flex:0 0 auto;width:24px;height:24px;margin-right:8px;place-items:center;border:1px solid transparent;border-radius:7px;color:var(--ui-primary);background:rgba(0,168,143,.08);transition:background-color var(--ui-transition),border-color var(--ui-transition),color var(--ui-transition),transform var(--ui-transition)}.plan-toggle-icon :deep(svg){width:13px;height:13px}.plan-toggle-icon.open{transform:rotate(90deg)}.plans :deep(.el-collapse-item__header:hover) .plan-toggle-icon{border-color:rgba(0,168,143,.22);background:#fff;color:var(--ui-primary-hover)}.plan-head strong{overflow:hidden;margin-right:10px;font-size:15px;text-overflow:ellipsis;white-space:nowrap}.plan-head .el-tag{margin-right:8px}.plan-head .muted{font-size:11px;line-height:1}
