...
<style scoped>
.database-console{max-width:1600px}.console-title{display:flex;align-items:center;gap:14px}.console-title .page-kicker{margin-bottom:0}.console-toolbar{display:flex;align-items:center;gap:10px;margin-bottom:14px;padding:11px 12px}.toolbar-label{color:var(--ui-text-secondary);font-size:12px;font-weight:600}.toolbar-spacer{flex:1}.editor-panel{overflow:hidden}.editor-panel.is-update{border-color:#dfc293}.editor-heading{display:flex;align-items:center;justify-content:space-between;gap:16px;padding:13px 15px;border-bottom:1px solid var(--ui-border)}.editor-heading strong,.editor-heading span{display:block}.editor-heading strong{font-size:13px}.editor-heading span{margin-top:3px;color:var(--ui-text-secondary);font-size:12px}.sql-editor{font-family:"Cascadia Code","JetBrains Mono",Consolas,monospace}.sql-editor :deep(.el-textarea__inner){border:0;border-radius:0;background:var(--ui-terminal);color:#d8e4e6;font:12px/1.7 "Cascadia Code","JetBrains Mono",Consolas,monospace;box-shadow:none}.sql-editor :deep(.el-textarea__inner:focus){box-shadow:inset 0 0 0 1px var(--ui-primary)!important}.result-panel{overflow:hidden;margin-top:14px}.result-meta{display:flex;align-items:center;justify-content:space-between;padding:14px 16px;border-bottom:1px solid var(--ui-border)}.result-empty{display:grid;min-height:190px;margin-top:14px;place-items:center;color:var(--ui-text-secondary);text-align:center}.result-empty strong,.result-empty span{display:block}.result-empty strong{color:var(--ui-text-primary);font-size:14px}.result-empty span{margin-top:5px;font-size:12px}@media(max-width:900px){.console-toolbar{flex-wrap:wrap}.toolbar-spacer{display:none}.console-toolbar .el-button{flex:1}.console-toolbar>.el-select{width:100%!important}}@media(max-width:767px){.editor-heading,.result-meta{align-items:flex-start;flex-direction:column}}
</style>
