          ...
          <template v-if="form.resource_type === 'rem'">
            ...
            <el-col :span="24">
              <div class="more-config-grid">
                ...
                <el-form-item class="trade-tcp-field" label="交易 TCP 端口" label-width="128px" required><el-input-number v-model="form.trade_tcp_port" :min="1" :max="65535" style="width:100%" /></el-form-item>
                <el-form-item class="trade-udp-field" label="交易 UDP 端口" label-width="128px" required><el-input-number v-model="form.trade_udp_port" :min="1" :max="65535" style="width:100%" /></el-form-item>
                ...
                <el-form-item class="query-port-field" label="查询端口" label-width="128px" required><el-input-number v-model="form.query_port" :min="1" :max="65535" style="width:100%" /></el-form-item>
              </div>
            </el-col>
