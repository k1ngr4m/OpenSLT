...
<template>
  <div class="page runs-page">
    ...
    <el-drawer v-model="drawer" title="创建测速运行" size="600px" destroy-on-close class="run-drawer">
      ...
      <el-form class="create-run-form" label-position="left" label-width="var(--ui-field-label-width)">
        <div class="plan-grid">
...
<style scoped>
.runs-page{max-width:1600px}.keyword-filter{width:min(360px,32vw)}.short-filter{width:160px}.filter-count{margin-left:auto;color:var(--ui-text-secondary);font-size:12px}.load-error{margin-bottom:14px}.table-panel{overflow:hidden}.clickable :deep(.el-table__row){cursor:pointer}.clickable strong,.clickable small{display:block}.clickable small{margin-top:3px}.run-id-cell{display:flex;align-items:center;gap:5px}.run-id-cell strong{font-size:12px}.run-id-cell .el-button{min-height:28px;opacity:0;transition:opacity var(--ui-transition)}.el-table__row:hover .run-id-cell .el-button,.run-id-cell:focus-within .el-button{opacity:1}.table-time{color:var(--ui-text-secondary);font-size:12px}.empty-action{margin-top:18px}.drawer-intro{margin:-4px 0 20px;padding:14px 15px}.drawer-intro p{margin:4px 0 0;line-height:1.6}.resource-section{margin-top:24px;padding-top:20px}.resource-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin-bottom:17px}.resource-heading strong,.resource-heading span{display:block}.resource-heading strong{font-size:14px}.resource-heading span{margin-top:4px;color:var(--ui-text-secondary)}.field-help{margin:5px 0 0}.create-summary{margin-top:24px;padding:15px;border:1px solid var(--ui-border);border-radius:8px;background:var(--ui-surface-subtle)}.create-summary>strong{font-size:13px}.create-summary dl{display:grid;grid-template-columns:86px 1fr;gap:8px 12px;margin:12px 0 0;font-size:12px}.create-summary dt{color:var(--ui-text-secondary)}.create-summary dd{margin:0;color:var(--ui-text-primary)}.drawer-footer{display:flex;gap:8px}
...
:deep(.run-drawer .el-drawer__body){padding:18px 22px 22px;overflow:auto;background:linear-gradient(180deg,var(--ui-surface) 0%,var(--ui-surface-subtle) 100%)}
:deep(.run-drawer .el-drawer__footer){padding:14px 22px;border-top:1px solid var(--ui-border);background:rgba(255,255,255,.96);}
.drawer-intro{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:14px;margin:0 0 16px;padding:12px 14px;border:1px solid #dce8e9;border-radius:8px;background:var(--ui-surface-subtle)}.drawer-intro strong{display:block;color:var(--ui-text-primary);font-size:14px;line-height:1.35}.drawer-intro p{margin:3px 0 0;color:var(--ui-text-secondary);font-size:12px;line-height:1.45}.drawer-flow{display:flex;align-items:center;gap:7px;padding:7px 8px;border:1px solid var(--ui-border);border-radius:7px;background:var(--ui-surface);color:var(--ui-text-secondary);font-size:12px;font-weight:650;white-space:nowrap}.drawer-flow i{width:16px;height:1px;background:var(--ui-border-strong)}
.create-run-form :deep(.el-form-item){margin-bottom:0}.create-run-form :deep(.el-form-item__label){color:var(--ui-text-primary);font-size:13px;font-weight:700}.create-run-form :deep(.el-select__wrapper){min-height:36px;border-radius:7px;transition:box-shadow var(--ui-transition),background-color var(--ui-transition)}.create-run-form :deep(.el-select__wrapper:hover){background:var(--ui-surface-subtle)}
.plan-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:18px}.resource-section{margin-top:0;padding-top:16px;border-top:1px solid var(--ui-border)}.resource-heading{align-items:center;margin-bottom:12px}.resource-heading strong{color:var(--ui-text-primary);font-size:15px}.resource-heading span{margin-top:3px;font-size:12px;line-height:1.35}.resource-list{display:grid;gap:9px}.resource-card{padding:10px 11px 11px;border:1px solid var(--ui-border);border-radius:8px;background:var(--ui-surface);box-shadow:inset 0 1px 0 rgba(255,255,255,.72);transition:border-color var(--ui-transition),box-shadow var(--ui-transition),transform var(--ui-transition)}.resource-card:hover{border-color:var(--ui-border-strong);box-shadow:0 5px 16px rgba(19,43,48,.06);transform:translateY(-1px)}.resource-card.empty{background:#fbf7f7}.resource-card-head{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-bottom:7px}.resource-card-head strong{min-width:0;overflow:hidden;color:var(--ui-text-primary);font-size:13px;text-overflow:ellipsis;white-space:nowrap}.resource-card-head strong::after{color:var(--ui-danger);content:" *"}.resource-card-count{flex:0 0 auto;color:var(--ui-text-tertiary);font-size:12px;font-weight:650}.resource-card-count.danger,.field-help.danger{color:var(--ui-danger)}.resource-card :deep(.el-form-item__content){display:block}.field-help{margin:6px 0 0;font-size:12px;line-height:1.45}
.create-summary{margin-top:14px;padding:13px;border-color:#dbe7e8;background:var(--ui-surface)}.create-summary>strong{display:block;color:var(--ui-text-primary);font-size:14px}.summary-tiles{display:grid;grid-template-columns:.85fr 1.35fr .8fr;gap:9px;margin-top:10px}.summary-tiles>div{min-width:0;padding:10px 11px;border:1px solid var(--ui-border);border-radius:7px;background:var(--ui-surface-subtle)}.summary-tiles span,.summary-tiles strong{display:block;min-width:0}.summary-tiles span{color:var(--ui-text-secondary);font-size:12px;font-weight:650}.summary-tiles strong{margin-top:5px;overflow:hidden;color:var(--ui-text-primary);font-size:13px;line-height:1.35;text-overflow:ellipsis;white-space:nowrap}.summary-tiles .mono{color:var(--ui-primary);font-size:17px;font-weight:750}
...
.resource-card { padding: 0; border: 0; border-radius: 0; background: transparent; box-shadow: none; }
