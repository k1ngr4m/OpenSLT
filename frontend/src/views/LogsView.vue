...
<style scoped>
.logs-page{max-width:1680px}.load-error{margin-bottom:14px}.log-workspace{overflow:hidden;padding:0 18px 18px}.log-workspace :deep(.el-tabs__header){margin-bottom:14px}.log-filters,.secondary-filters{margin-bottom:10px}.log-filters>.el-select,.secondary-filters>.el-select{width:145px}.trace-filter{width:220px}.keyword-filter{width:min(280px,22vw)}.secondary-filters>.el-input{width:260px}.filter-actions,.audit-actions{display:flex;align-items:center;justify-content:flex-end;gap:10px;margin-bottom:12px;color:var(--ui-text-secondary);font-size:12px}.audit-actions{justify-content:space-between}.table-time{color:var(--ui-text-secondary);font-size:12px}.trace-cell{display:flex;align-items:center;gap:5px}.trace-cell>span{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px}.trace-cell .el-button{min-height:28px;opacity:0}.trace-cell:hover .el-button,.trace-cell:focus-within .el-button{opacity:1}.el-pagination{justify-content:flex-end;margin-top:12px}.detail-content{min-height:180px}.detail-meta{display:grid;grid-template-columns:90px 1fr;gap:8px 12px;margin:0 0 24px}.detail-meta dt{color:var(--ui-text-tertiary)}.detail-meta dd{min-width:0;margin:0;overflow-wrap:anywhere}.detail-content h3{margin:22px 0 8px;font-size:13px}.detail-content pre{max-height:360px;margin:0;overflow:auto;padding:14px;border:1px solid var(--ui-border);border-radius:6px;background:var(--ui-terminal);color:#d9e8e6;font:12px/1.6 var(--ui-font-mono);white-space:pre-wrap;overflow-wrap:anywhere}
