...
<style scoped>
.dashboard-page{max-width:1600px}.load-error{margin-bottom:12px}.overview-strip{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));overflow:hidden;margin-bottom:12px;border:1px solid var(--ui-border);border-radius:var(--ui-radius-panel);background:var(--ui-border)}.overview-item{display:grid;min-width:0;padding:14px 16px 15px;border:0;background:var(--ui-surface);color:var(--ui-text-primary);text-align:left;cursor:pointer;transition:background-color var(--ui-transition-fast)}.overview-item+*{border-left:1px solid var(--ui-border)}.overview-item:hover{background:#f3f8f7}.overview-item:focus-visible{position:relative;z-index:1}.overview-item span{color:var(--ui-text-secondary);font-size:11px;font-weight:500}.overview-item strong{margin-top:5px;font-family:var(--ui-font-mono);font-size:26px;font-weight:650;letter-spacing:-.04em}.overview-item small{margin-top:4px;color:var(--ui-text-tertiary);font-size:10px}.overview-item.is-warning strong{color:var(--ui-warning)}.overview-item.is-danger strong{color:var(--ui-danger)}.overview-item.is-success strong{color:var(--ui-success)}.dashboard-grid{display:grid;grid-template-columns:minmax(0,2fr) minmax(280px,1fr);align-items:start;gap:12px}.section-heading{padding:13px 15px}.section-heading h2{font-size:16px}.section-heading p{margin:3px 0 0;color:var(--ui-text-tertiary);font-size:11px}.recent-panel{min-width:0;overflow:hidden}.run-table{border-radius:0}.run-table :deep(.el-table__row){cursor:pointer}.run-number{font-size:11px;white-space:nowrap}.run-table strong,.run-table small{display:block}.run-table small{margin-top:3px;color:var(--ui-text-secondary);font-size:11px}.table-time{color:var(--ui-text-secondary);font:11px/1.4 var(--ui-font-mono)}.empty-action{margin-top:16px}.attention-column{display:grid;gap:0;overflow:hidden;border:1px solid var(--ui-border);border-radius:var(--ui-radius-panel);background:var(--ui-surface)}.attention-column>.card{border:0;border-radius:0}.attention-column>.card+.card{border-top:1px solid var(--ui-border)}.count{color:var(--ui-warning);font:600 11px/1 var(--ui-font-mono)}.attention-list,.resource-list{display:grid}.attention-row,.resource-list button{display:flex;width:100%;align-items:center;gap:10px;padding:11px 14px;border:0;border-bottom:1px solid var(--ui-border);background:transparent;color:var(--ui-text-primary);text-align:left;cursor:pointer;transition:background-color var(--ui-transition-fast)}.attention-row:last-child,.resource-list button:last-child{border-bottom:0}.attention-row:hover,.resource-list button:hover{background:#f3f8f7}.attention-row>.el-icon{flex:0 0 auto;font-size:16px}.warning-icon{color:var(--ui-warning)}.danger-icon{color:var(--ui-danger)}.attention-row>span,.resource-list button>span{min-width:0;flex:1}.attention-row strong,.attention-row small,.resource-list strong,.resource-list small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.attention-row strong{font-size:11px}.attention-row small,.resource-list small{margin-top:3px;color:var(--ui-text-secondary);font-size:10px}.compact-empty{display:flex;align-items:center;gap:11px;padding:20px 15px;color:var(--ui-warning)}.compact-empty.is-success{color:var(--ui-success)}.compact-empty>.el-icon{font-size:20px}.compact-empty strong,.compact-empty span{display:block}.compact-empty strong{color:var(--ui-text-primary);font-size:12px}.compact-empty span{margin-top:3px;color:var(--ui-text-tertiary);font-size:10px}.resource-panel .section-heading>.el-icon{color:var(--ui-success);font-size:18px}.resource-list button{justify-content:space-between}.resource-list strong{font-size:12px}
@media(max-width:1199px){.dashboard-grid{grid-template-columns:1fr}.attention-column{grid-template-columns:repeat(2,minmax(0,1fr))}.attention-column>.card+.card{border-top:0;border-left:1px solid var(--ui-border)}}
...
@media(max-width:767px){.overview-strip{grid-template-columns:1fr}.overview-item+*{border-top:1px solid var(--ui-border);border-left:0}.attention-column{grid-template-columns:1fr}.attention-column>.card+.card{border-top:1px solid var(--ui-border);border-left:0}.run-table :deep(.el-table__body-wrapper),.run-table :deep(.el-table__header-wrapper){overflow-x:auto}}
</style>
